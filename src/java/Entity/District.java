...
@NamedQueries({
    ...
    , @NamedQuery(name = "District.findByDesdistrict", query = "SELECT d FROM District d WHERE d.desdistrict = :desdistrict")
    , @NamedQuery(name = "District.findByDesregion", query = "SELECT d FROM District d WHERE d.desregion = :desregion")})
public class District implements Serializable {
    ...
    public District(Integer id, String desdistrict, String desregion) {
        this.id = id;
